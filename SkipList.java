...
public class SkipList<T extends Comparable<? super T>> {
    ...
    protected class SkipListIterator<T extends Comparable<? super T>> implements Iterator {
	    private Entry<T> nextEntry;
	    public SkipListIterator(Entry<T> head) {
	        return nextEntry = (Entry<T>) tail.next[0];
	    }
	    public boolean hasNext(){
	        return nextEntry != tail;
	    }
	    public Object next() {
	        if (nextEntry != tail){
	            Object obj = nextEntry.element;
